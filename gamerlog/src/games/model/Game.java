...
/**
 * Game.java
 * This is a model class represents a Game entity
...
public class Game {
	...
	protected String image;
	 ...
	 public Game(int ID, String title, String yearReleased, String developers, String publishers, String genres, String image) {
	  super();
	  this.ID = ID;
	  this.title = title;
	  this.yearReleased = yearReleased;
	 ...
	 public void setCountry(String image) {
	 	this.image = image;
	 } 
	}
